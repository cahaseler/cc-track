...
To begin a new task, the user should run the /specify command to begin creating a specification. If they seem to want to begin complex outcome driven work, you should suggest this but don't be insistent if they don't want to.
