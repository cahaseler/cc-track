...
- [2025-12-07] Adjust code review agent guidelines to specify non-background parallel execution.- [2025-12-07] Apply orchestration lessons from Task 111 to tasks.md command and tasks-template.md - see .cc-track/specs/111-align-planning-phase-with-phase-based-task-orchest/tasks.md Notes section for: (1) pipeline flow pattern instead of batch-wait, (2) dependency enforcement rules, (3) remove redundant phase counter from template
