# Progress: TASK_060: Fix Capture-Plan Hook to Commit Task Files Without CLAUDE.md Updates
...
- Converted from tasks/TASK_060.md to specs/060-*/ directory structure
